...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <?php else: ?>
        <div class="col-span-full bg-white rounded-xl border border-gray-200 p-12 text-center">
            ...
            <p class="text-gray-600 font-medium">Tidak terdaftar di mata praktikum</p>
            <p class="text-gray-500 text-sm mb-4">Anda belum terdaftar di mata praktikum untuk semester ini</p>
